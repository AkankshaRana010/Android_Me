...
public class BodyPartFragment extends Fragment {
    ...
    //putting the current state in a bundle and saving it when the device rotates
    @Override
    public void onSaveInstanceState(Bundle currentState) {
        //attaching the current imageList to IMAGE_ID_LIST
        currentState.putIntegerArrayList(IMAGE_ID_LIST, (ArrayList<Integer>) mImageIds);
        //attaching the current List index to the LIST_INDEX
